...
if (file_exists('config/config.php')) {
    ...
    if($hasOptions == "Yes") :
        ...
        foreach($resulto as $row) :
            ...
            $topbartext = isset($row['topbartext']) ? $row['topbartext'] : "#FFFFFF";
            ...
            $hoverbg = isset($row['hoverbg']) ? $row['hoverbg'] : "#ECECEC";
            $activetabBG = isset($row['activetabBG']) ? $row['activetabBG'] : "#E5A00D";
            ...
            $inactiveicon = isset($row['inactiveicon']) ? $row['inactiveicon'] : "#FFFFFF";
            $inactivetext = isset($row['inactivetext']) ? $row['inactivetext'] : "#999999";
            $loading = isset($row['loading']) ? $row['loading'] : "#3F4245";
...
<html lang="<?php echo $language->getLang(); ?>" class="no-js">
    ...
    <head>
		...
		<link rel="mask-icon" href="<?=$baseURL;?>images/favicon/safari-pinned-tab.svg" color="#e5a00d">
		<link rel="shortcut icon" href="<?=$baseURL;?>images/favicon/favicon.ico">
		<meta name="apple-mobile-web-app-title" content="Organizr">
		<meta name="application-name" content="Organizr">
                    ...
                    <nav class="gn-menu-wrapper">
                        ...
                        <div class="gn-scroller" id="gn-scroller">
                            ...
                            <ul id="tabList" class="gn-menu metismenu">
                                ...
                                <li class="login-tab-item" data-title="Admin Login" name="login">
                                    <a class="log-in">
	                                    <login class="login-btn">ADMIN LOGIN</login>
                                    </a>
                                </li>
                                <?php endif; endif;?>
                                <!--End Tab List-->
                    ...
                    <ul class="nav navbar-right right-menu">
                        ...
                        <li class="dropdown some-btn">
                            ...
                            <a class="show-members">
                                <i class="userpic"><i class="mdi mdi-account"></i></i>
                            </a>
            ...
            <div id="members-sidebar" style="background: <?=$sidebar;?>;" class="members-sidebar fade in">
                ...
                <div class="content-box profile-sidebar box-shadow">
                    ...
                    <div id="buttonsDiv" class="profile-userbuttons">
                        ...
                        <button type="button" class="btn btn-danger text-uppercase waves waves-effect waves-float close-members-sidebar">CLOSE</button>
